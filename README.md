...
## Usage
```
$ git clone https://github.com/umarelx/IndoorMapping.git
$ cd IndoorMapping
$ mkdir build && cd build
$ cmake ..
$ make
...
![](https://raw.githubusercontent.com/umarelx/p/master/IndoorMapping/1.jpeg)
...
![](https://raw.githubusercontent.com/umarelx/p/master/IndoorMapping/2.jpeg)
...
## License
This repository is licensed under Apache 2.0. Full license text is available in [LICENSE](https://github.com/umarelx/IndoorMapping/blob/master/LICENSE).
